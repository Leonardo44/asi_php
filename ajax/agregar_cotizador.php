...
<?php
	...
	$sumador_total+=$precio_total_r;//Sumador
		...
		<tr>
			...
			<td><?= $cantidad;?></td>
			<td><?= $nombre_producto.$marca_producto;?></td>
			<td><span class="pull-right"><?= $precio_venta_f;?></span></td>
			<td><span class="pull-right"><?= $precio_total_f;?></span></td>
			<td ><span class="pull-right"><a href="#" onclick="eliminar('<?= $id_tmp ?>')"><i class="glyphicon glyphicon-trash"></i></a></span></td>
		</tr>		
		<?php
	}
...
<tr>
	...
	<td><span class="pull-right"><?= number_format($sumador_total,2);?></span></td>
	<td></td>
</tr>
</table>
